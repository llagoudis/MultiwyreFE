                ...
                <Tab
                  ...
                  className={({ selected }) =>
                    classNames(
                      ...
                      selected
                        ? "border-b-[3px] border-pink-500 pb-4 font-bold text-white"
            ...
            <div className="flex gap-3 ">
              {isDashboard ? null : (
                <button
                  ...
                  className="flex items-center gap-2 rounded-md border border-slate-200 bg-white px-4 py-2 text-sm  text-white shadow-sm transition hover:bg-slate-50 disabled:cursor-not-allowed disabled:opacity-60 text-white"
                >

...
const ReconciliationReportOTC: React.FC<ReconciliationReportProps> = ({
  row,
}) => {
  ...
  function assetSymbol(asset: string) {
    return asset === TEST_COINS.BTC_TEST || asset === TEST_COINS.BTC
      ...
      ? "€"
      : asset === TEST_COINS.TRX_TEST || asset === TEST_COINS.TRX_USDT_S2UZ
      ? "$"
      : "";
  }
  ...
  return (
    <div style={{ padding: "5rem" }}>
      ...
      >
        {row?.companyLegalName ? row.companyLegalName.toUpperCase() : "---"}{" "}
        operated by General Payments Gate Limited - Reg. Number BC1354852 &
        License number: M22457458
      </p>
    </div>
  );
};

export default ReconciliationReportOTC;

...
const ReconciliationReportSafari: React.FC<ReconciliationReportProps> = ({
  row,
  companyLegalName,
}) => {
  ...
  return (
    <div style={{ width: "auto", margin: "2rem auto" }}>
      ...
      >
        {companyLegalName ?? "---"} operated by General Payments Gate Limited -
        Reg. Number BC1354852 & License number: M22457458
      </p>
    </div>
  );
};

export default ReconciliationReportSafari;
